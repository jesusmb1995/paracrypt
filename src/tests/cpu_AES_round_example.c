// File for testing and developing purposes
...
//	[2017-04-11 18:17:52.136974] [0x00007ff5ec390780] [trace]   round 5: t3 => 0x97ecc395
	{
		unsigned char k0_[4] = {0x0c, 0x7b, 0x5a, 0x63};
		unsigned char k1_[4] = {0x13, 0x19, 0xea, 0xfe};
		unsigned char k2_[4] = {0xb0, 0x39, 0x88, 0x90};
		unsigned char k3_[4] = {0x66, 0x4c, 0xfb, 0xb4};
		uint32_t k0 = *((uint32_t*)k0_);
		uint32_t k1 = *((uint32_t*)k1_);
		uint32_t k2 = *((uint32_t*)k2_);
		uint32_t k3 = *((uint32_t*)k3_);
	...
	// Last decrypt round
//	[2017-04-11 18:58:01.313351] [0x00007ffa95ae2780] [trace]   round 1: t0 => 0xd4bf5d30
//	[2017-04-11 18:58:01.313381] [0x00007ffa95ae2780] [trace]   round 1: t1 => 0xe0b452ae
//	[2017-04-11 18:58:01.313411] [0x00007ffa95ae2780] [trace]   round 1: t2 => 0xb84111f1
//	[2017-04-11 18:58:01.313440] [0x00007ffa95ae2780] [trace]   round 1: t3 => 0x1e2798e5
//	[2017-04-11 18:58:01.313468] [0x00007ffa95ae2780] [trace]   last: k[0] => 0x2b7e1516
//	[2017-04-11 18:58:01.313495] [0x00007ffa95ae2780] [trace]   last: k[1] => 0x28aed2a6
//	[2017-04-11 18:58:01.313524] [0x00007ffa95ae2780] [trace]   last: k[2] => 0xabf71588
//	[2017-04-11 18:58:01.313551] [0x00007ffa95ae2780] [trace]   last: k[3] => 0x09cf4f3c
//	[2017-04-11 18:58:01.313577] [0x00007ffa95ae2780] [trace]   last_decrypt: (t0 >> 24)        => 0xd4
//	[2017-04-11 18:58:01.313604] [0x00007ffa95ae2780] [trace]   last_decrypt: (t3 >> 16) & 0xff => 0x27
//	[2017-04-11 18:58:01.313630] [0x00007ffa95ae2780] [trace]   last_decrypt: (t2 >>  8) & 0xff => 0x11
//	[2017-04-11 18:58:01.313657] [0x00007ffa95ae2780] [trace]   last_decrypt: (t1      ) & 0xff => 0xae
//	[2017-04-11 18:58:01.313693] [0x00007ffa95ae2780] [trace]   last_decrypt: do0 = 0x19000000 ^ 0x3d0000 ^ 0xe300 ^ 0xbe ^ 0x2b7e1516
//	[2017-04-11 18:58:01.313721] [0x00007ffa95ae2780] [trace]   last: s0 => 0x3243f6a8
//	[2017-04-11 18:58:01.313749] [0x00007ffa95ae2780] [trace]   last: s1 => 0x885a308d
//	[2017-04-11 18:58:01.313775] [0x00007ffa95ae2780] [trace]   last: s2 => 0x313198a2
//	[2017-04-11 18:58:01.313801] [0x00007ffa95ae2780] [trace]   last: s3 => 0xe0370734
		{
			unsigned char k0_[4] = {0x2b, 0x7e, 0x15, 0x16};
			unsigned char k1_[4] = {0x28, 0xae, 0xd2, 0xa6};
			unsigned char k2_[4] = {0xab, 0xf7, 0x15, 0x88};
			unsigned char k3_[4] = {0x09, 0xcf, 0x4f, 0x3c};
			uint32_t k0 = *((uint32_t*)k0_);
			uint32_t k1 = *((uint32_t*)k1_);
			uint32_t k2 = *((uint32_t*)k2_);
			uint32_t k3 = *((uint32_t*)k3_);
			...
			// En realidad el input es por columnas
			unsigned char j0[4] = {0xd4, 0xbf, 0x5d, 0x30};
			unsigned char j1[4] = {0xe0, 0xb4, 0x52, 0xae};
			unsigned char j2[4] = {0xb8, 0x41, 0x11, 0xf1};
			unsigned char j3[4] = {0x1e, 0x27, 0x98, 0xe5};
			// Operar en formato big-endian (si la máquina es little)
			// y saltarnos el paso de convertir los datos a little-endian
			uint32_t j0be = *((uint32_t*)j0);
			uint32_t j1be = *((uint32_t*)j1);
			...
			hexdump("j2be",(unsigned char*)&j2be,4);
			hexdump("j3be",(unsigned char*)&j3be,4);
		    LOG_TRACE(boost::format("last_decrypt: (j0be      ) & 0xff => 0x%x") % ((j0be      ) & 0xff));
		    LOG_TRACE(boost::format("last_decrypt: (j3be >>  8) & 0xff => 0x%x") % ((j3be >>  8) & 0xff));
		    LOG_TRACE(boost::format("last_decrypt: (j2be >> 16) & 0xff => 0x%x") % ((j2be >> 16) & 0xff));
		    LOG_TRACE(boost::format("last_decrypt: (j1be >> 24)        => 0x%x") % ((j1be >> 24)       ));
		    LOG_TRACE(boost::format("last_decrypt: (uint32_t)Td4_be[(j0be      ) & 0xff] => 0x%x") % ((uint32_t)Td4_be[(j0be      ) & 0xff]));
		    LOG_TRACE(boost::format("last_decrypt: (uint32_t)Td4_be[(j3be >>  8) & 0xff] => 0x%x") % ((uint32_t)Td4_be[(j3be >>  8) & 0xff]));
		    LOG_TRACE(boost::format("last_decrypt: (uint32_t)Td4_be[(j2be >> 16) & 0xff] => 0x%x") % ((uint32_t)Td4_be[(j2be >> 16) & 0xff]));
		    LOG_TRACE(boost::format("last_decrypt: (uint32_t)Td4_be[(j1be >> 24)       ] => 0x%x") % ((uint32_t)Td4_be[(j1be >> 24)       ]));
		    LOG_TRACE(boost::format("last_decrypt: do0 = 0x%x ^ 0x%x ^ 0x%x ^ 0x%x ^ 0x%x")
		    % ((uint32_t)Td4_be[(j0be      ) & 0xff]      )
		    % ((uint32_t)Td4_be[(j3be >>  8) & 0xff] <<  8)
		    % ((uint32_t)Td4_be[(j2be >> 16) & 0xff] << 16)
		    % ((uint32_t)Td4_be[(j1be >> 24)       ] << 24)
		    % k0
		    );
		    uint32_t do0 =
		        ((uint32_t)Td4_be[(j0be      ) & 0xff]      ) ^
		        ...
		        k0;
		    uint32_t do1 =
		        ((uint32_t)Td4_be[(j1be      ) & 0xff]      ) ^
		        ((uint32_t)Td4_be[(j0be >>  8) & 0xff] <<  8) ^
		        ((uint32_t)Td4_be[(j3be >> 16) & 0xff] << 16) ^
		        ((uint32_t)Td4_be[(j2be >> 24)       ] << 24) ^
		        k1;
		    uint32_t do2 =
		        ((uint32_t)Td4_be[(j2be      ) & 0xff]      ) ^
		        ((uint32_t)Td4_be[(j1be >>  8) & 0xff] <<  8) ^
		        ((uint32_t)Td4_be[(j0be >> 16) & 0xff] << 16) ^
		        ((uint32_t)Td4_be[(j3be >> 24)       ] << 24) ^
		        k2;
		    uint32_t do3 =
		        ((uint32_t)Td4_be[(j3be      ) & 0xff]      ) ^
		        ((uint32_t)Td4_be[(j2be >>  8) & 0xff] <<  8) ^
		        ((uint32_t)Td4_be[(j1be >> 16) & 0xff] << 16) ^
		        ((uint32_t)Td4_be[(j0be >> 24)       ] << 24) ^
		        k3;
			hexdump("do0",(unsigned char*)&do0,4);
			hexdump("do1",(unsigned char*)&do1,4);
			hexdump("do2",(unsigned char*)&do2,4);
			hexdump("do3",(unsigned char*)&do3,4);
		}
