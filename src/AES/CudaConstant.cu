...
__device__ __constant__ uint32_t aes_key[4*(14+1)];

__host__ uint32_t* __setAesKey__(uint32_t* keyWords, int nWords)
{
	cudaMemcpyToSymbol(aes_key, keyWords, nWords*sizeof(uint32_t),0,cudaMemcpyHostToDevice);
	uint32_t* devPtr;
	cudaGetSymbolAddress((void**)&devPtr,aes_key);
	return devPtr;
}
...
{
	uint32_t* devPtr;
	cudaGetSymbolAddress((void**)&devPtr,aes_Te0);
	return devPtr;
}
...
{
	uint32_t* devPtr;
	cudaGetSymbolAddress((void**)&devPtr,aes_Te1);
	return devPtr;
}
...
{
	uint32_t* devPtr;
	cudaGetSymbolAddress((void**)&devPtr,aes_Te2);
	return devPtr;
}
...
{
	uint32_t* devPtr;
	cudaGetSymbolAddress((void**)&devPtr,aes_Te3);
	return devPtr;
}
...
{
	uint32_t* devPtr;
	cudaGetSymbolAddress((void**)&devPtr,aes_Td0);
	return devPtr;
}
__host__ uint32_t* __Td1__()
{
	uint32_t* devPtr;
	cudaGetSymbolAddress((void**)&devPtr,aes_Td1);
	return devPtr;
}
...
{
	uint32_t* devPtr;
	cudaGetSymbolAddress((void**)&devPtr,aes_Td2);
	return devPtr;
}
...
{
	uint32_t* devPtr;
	cudaGetSymbolAddress((void**)&devPtr,aes_Td3);
	return devPtr;
}
...
{
	uint8_t* devPtr;
	cudaGetSymbolAddress((void**)&devPtr,aes_Td4);
	return devPtr;
}
