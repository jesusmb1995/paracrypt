...
int main()
{
	big((uint32_t*)&Te0,(uint32_t*)&Te0,256);
	big((uint32_t*)&Te1,(uint32_t*)&Te1,256);
	big((uint32_t*)&Te2,(uint32_t*)&Te2,256);
	big((uint32_t*)&Te3,(uint32_t*)&Te3,256);

	big((uint32_t*)&Td0,(uint32_t*)&Td0,256);
