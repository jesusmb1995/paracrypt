...
int paracrypt::CudaAES8BPtr::cuda_aes_encrypt(
   		int gridSize,
   		int threadsPerBlock,
	...
	DEV_TRACE(boost::format("cuda_aes_8b_ptr_encrypt("
			"gridSize=%d"
			", threadsPerBlock=%d"
			", data=%x"
			", n_blocks=%d"
...
int paracrypt::CudaAES8BPtr::cuda_ecb_aes_decrypt(
	...
	DEV_TRACE(boost::format("cuda_aes_8b_ptr_decrypt("
			"gridSize=%d"
			", threadsPerBlock=%d"
			", data=%x"
			", n_blocks=%d"
